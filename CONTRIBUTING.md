...
Code changes that are known or suspected to break support for any currently supported hardware are not allowed. Contributors should make a reasonable effort to ensure compatibility with these platforms. If a contribution inadvertently affects hardware support, the community will work together to address and resolve the issue.
