...
run_chain_bench(int num_executions, int num_inputs, int num_nodes, double generation_rate, int num_resources) {
...
int main(int argc, char* argv[]) {
    ...
    // Run benchmark
    auto [construction_time, execution_time] = run_chain_bench(num_executions, num_inputs, num_nodes, generation_rate, num_resources);
