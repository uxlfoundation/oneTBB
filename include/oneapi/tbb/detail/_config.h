...
#ifndef __TBB_PREVIEW_FLOW_GRAPH_RESOURCE_LIMITED_NODE
#define __TBB_PREVIEW_FLOW_GRAPH_RESOURCE_LIMITED_NODE (TBB_PREVIEW_FLOW_GRAPH_FEATURES \
                                                        || TBB_PREVIEW_FLOW_GRAPH_RESOURCE_LIMITED_NODE)
#endif
