...
When executed serially ``parallel_reduce`` runs sequentially from left to right in the same sense as for ``parallel_for``.
...
.. literalinclude:: ./examples/parallel_reduce_imperative_example.cpp
    :language: c++
    :start-after: /*begin_parallel_reduce_imperative_example*/
    :end-before: /*end_parallel_reduce_imperative_example*/
...
.. literalinclude:: ./examples/parallel_reduce_lambda_example.cpp
    :language: c++
    :start-after: /*begin_parallel_reduce_lambda_example*/
    :end-before: /*end_parallel_reduce_lambda_example*/
