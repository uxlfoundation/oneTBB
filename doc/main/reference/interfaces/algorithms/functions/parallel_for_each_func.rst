...
The following code demonstrates how ``feeder`` can add new work items while items are being processed.

.. literalinclude:: ./examples/parallel_for_each_example.cpp
    :language: c++
    :start-after: /*begin_parallel_for_each_example*/
    :end-before: /*end_parallel_for_each_example*/
