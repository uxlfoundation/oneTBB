...
.. code:: cpp
    ...
    namespace flow {
        ...
        public:
            ...
            join_node( graph &g ); // Preview feature: Type-Specified Message Keys
        ...
        // Preview feature: Type-Specified Message Keys
...
* :ref:`Waiting for Single Message in Flow Graph<try_put_and_wait>` - allows to put messages
  to input ports of ``join_node`` and wait for all related work to complete.
