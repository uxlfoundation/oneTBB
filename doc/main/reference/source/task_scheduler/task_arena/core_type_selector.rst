...
.. note::
   ...
   ``TBB_PREVIEW_TASK_ARENA_CORE_TYPE_SELECTOR`` macro to 1.
   When available and enabled, the feature-test macro ``TBB_HAS_TASK_ARENA_CORE_TYPE_SELECTOR`` is defined.
...
and the :ref:`tbb::info <info_namespace>` specifications with the following API:
...
.. code:: cpp
    ...
    // Defined in header <oneapi/tbb/info.h>
