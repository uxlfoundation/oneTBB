...
|                |                  | Language RT is maintained.   |                               |
+----------------+------------------+------------------------------+-------------------------------+
| Pending        | Not allowed      | **Warm** or **Cold**.        |                               |
|                |                  | Language RT waits for the    |                               |
|                |                  | permit to be granted.        |                               |
+----------------+------------------+------------------------------+-------------------------------+
| Idle           | Allowed          | **Hot**: Team is at          | Fastest                       |
|                |                  | quiescent point, might       |                               |
|                |                  | actively spin. Highly        |                               |
|                |                  | configured for Language RT.  |                               |
+----------------+------------------+------------------------------+-------------------------------+
| Active         | Allowed          | **Active**: Team is          | (Already Active)              |
|                | (permit granted) | executing tasks for          |                               |
|                |                  | Language RT. Highly          |                               |
|                |                  | configured for Language RT.  |                               |
+----------------+------------------+------------------------------+-------------------------------+
