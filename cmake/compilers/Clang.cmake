...
set(TBB_COMMON_COMPILE_FLAGS ${TBB_COMMON_COMPILE_FLAGS} -Wformat -Wformat-security -Werror=format-security $<$<PLATFORM_ID:Windows>:-D_CRT_SECURE_NO_WARNINGS> $<$<NOT:$<PLATFORM_ID:Windows>>:-fPIC> $<$<NOT:$<BOOL:${EMSCRIPTEN}>>:-fstack-protector-strong>)
